...
<div style="width: 95%; max-width: 1600px; overflow: hidden; border: 1px solid #ccc; padding: 10px; margin:  0 auto;">
  <div id="content" style="max-height: 260px; overflow: hidden; transition: max-height 0.5s ease;">
    ...
    <i><b>Apr. 27, 2026.</b></i> Four papers (on <a href="https://arxiv.org/abs/2604.07644">millisecond-speed reachability and robust MPC on the GPU</a>, on <a href="https://arxiv.org/abs/2602.09368">robust control and reachability for contact-rich manipulation</a>, on <a href="TBD">certified training of neural dynamics and controllers</a>, and on <a href="https://arxiv.org/abs/2604.24894">safe, information-gathering vision-based control</a>) accepted to RSS 2026.<br>
